  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-[#0f172a]">eSIM Management</h1>
          <p className="text-[#0f172a]/60">Monitor activations and manage profiles for MVNO services.</p>
        </div>
      ...
      <div className="flex gap-3 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Search by ICCID, IMEI, or Phone..."
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center shadow-sm">
        ...
        <h3 className="text-lg font-semibold text-[#0f172a] mb-2">No active eSIMs</h3>
        <p className="text-sm text-[#0f172a]/50">
          Your managed eSIM profiles and their connection statuses will appear here.
        </p>
      </div>
    </div>
  );
