  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-[#0f172a]">Bulk Orders</h1>
          <p className="text-[#0f172a]/60">Manage large shipments and B2B purchase agreements.</p>
        </div>
      </div>
      ...
      <div className="flex gap-3 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Search manifest ID or buyer..."
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center shadow-sm">
        ...
        <h3 className="text-lg font-semibold text-[#0f172a] mb-2">No active shipments</h3>
        <p className="text-sm text-[#0f172a]/50">
          Your bulk distribution history will be tracked here.
        </p>
      </div>
    </div>
  );
