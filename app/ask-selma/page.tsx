...
export default function AskSelmaPage() {
      ...
      <section className="flex-1 flex flex-col pt-24 pb-4 px-6 max-w-5xl mx-auto w-full min-h-0 relative z-10">
          ...
          {!hasMessages && (
            ...
            >
              ...
              <p className="text-lg text-[#0f172a]/40 max-w-2xl mx-auto font-medium leading-relaxed">
                Your Select Mobile Phone Assistant. Ask about phones, plans,
                trade-ins, cross-border coverage, or anything mobile.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
            ...
            >
              {QUICK_PROMPTS.map((qp, idx) => (
                <motion.button
                  ...
                  className="bg-white/80 backdrop-blur-sm p-5 rounded-4xl border border-white text-left cursor-pointer hover:shadow-xl hover:shadow-[#04a1c6]/5 transition-all group"
                >
        ...
        >
          {messages.map((msg) => (
            ...
            >
              ...
              <div
                className={`max-w-[80%] px-6 py-4 rounded-4xl text-sm leading-relaxed shadow-sm border ${
                  msg.role === "USER"
          ...
          {loading && (
            ...
            >
              ...
              <div className="bg-white border-white border text-[#0f172a]/40 px-6 py-4 rounded-4xl rounded-tl-sm text-xs font-black uppercase tracking-widest shadow-sm">
        ...
        <div className="shrink-0 pt-4 pb-2">
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-linear-to-r from-[#04a1c6] to-indigo-600 rounded-[2.5rem] opacity-20 group-focus-within:opacity-40 blur transition-all duration-500" />
            <div className="relative bg-white rounded-[2.5rem] border border-white p-2 shadow-2xl flex items-center gap-2">
              ...
              <input
                ...
                placeholder="Ask SELMA about phones, plans, trade-ins..."
              ...
              <button
                ...
                aria-label="Send message to SELMA"
              >
          ...
          <p className="text-center text-[10px] font-black uppercase tracking-[0.2em] text-[#0f172a]/20 mt-6">
            SELMA uses Select Mobile marketplace data. For account-specific help,{" "}
